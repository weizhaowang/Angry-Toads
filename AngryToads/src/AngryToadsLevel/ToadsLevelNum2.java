...
public class ToadsLevelNum2 extends AngryToadsArea{
	...
	public void initStage(){
		...
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos1.x-1f,pos1.y+0.5f), 0.45f, 1f, 0));
		this.obList.add(new AngryToadsObstacles().createObstacles(this.sworld, 0, pos.set(pos1.x+1,pos1.y+0.5f), 0.45f, 1f, 0));
		this.toadList.add(nEnemy.createEnemy(this.sworld, 0, pos.set(pos1.x,pos1.y+0.5f)));
		pos1.set(pos1.x,pos1.y+1.5f);
		...
		this.toadList.add(nEnemy.createEnemy(this.sworld, 0, pos.set(pos1.x+0.5f,pos1.y+1f)));
		this.toadList.add(nEnemy.createEnemy(this.sworld, 0, pos.set(pos1.x+2.5f,pos1.y+1f)));
		toadBullets = 0;
